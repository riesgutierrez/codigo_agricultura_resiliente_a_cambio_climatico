...
SAVI, ARVI, EVI, que se presentan en una coleccion de imagenes multiespectrales PLANET de 4,7 m
...
var vismask = ndvi.map(function (c){return c.visualize(parametrosndvi).mask(c.gte(0.5))})

/*Se realiza el mismo procedimiento para los otros indices SAVI, ARVI, EVI*/
...
var timeserie2 = ui.Thumbnail(vismask, viscontrol)
...
Map.onClick(function(click){
  ...
  Map.centerObject(punto, 16)
    ...
    .series({
      imageCollection: coleccion1.select("NDVI","SAVI","ARVI","EVI"),
      region: punto, 
      reducer: ee.Reducer.mean(), 
      scale: 4.7,
      xProperty: 'system:time_start'
    })
    .setSeriesNames(["NDVI","SAVI","ARVI","EVI"])
    .setOptions({
